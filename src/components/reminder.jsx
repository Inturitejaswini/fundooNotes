    ...
    return (
      <div>
        <IconButton
          ...
          aria-describedby={id}
          type="button"
          onClick={this.handleReminderMenu}
        >
          <div className="AddAlertIcon" title="more">
            <AddAlertIcon />
          </div>
        </IconButton>
        <Popper
          ...
          open={open}
          anchorEl={anchorEl}
          className="reminder-popper-paper"
        >
          <Paper className="reminder-paper">
            <div className="reminder-div">Reminder:</div>
            <div id="remainder-div-btns">
              <Setdateandtime remainderId={this.props.noteId}></Setdateandtime>
            </div>
          </Paper>
        </Popper>
      </div>
